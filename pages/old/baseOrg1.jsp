...
<head>
    ...
    <script type="text/javascript" src="../../static/frameworks/bootstrap/js/jquery.min.js"></script>
    <!-- 最新的 Bootstrap 核心 JavaScript 文件 -->
    <script type="text/javascript" src="../../static/frameworks/bootstrap/js/bootstrap.min.js"></script>
    <!-- BootStrap-table文件，不可少-->
    <script type="text/javascript" src="../../static/frameworks/bootstrap/js/bootstrap-table.js"></script>
    <!-- 国际化，表格汉化 -->
    <script type="text/javascript" src="../../static/frameworks/bootstrap/js/bootstrap-table-zh-CN.min.js"></script>
    <script type="text/javascript" src="../../static/frameworks/bootstrap/js/bootstrap-table-editable.js"></script>
...
<div class="container">
    ...
    <table id="table"
           ...
           data-url="http://192.168.1.200:8080/api/baseOrgs"
           datatype="json"
           data-local="zh-US"
            >
    </table>
...
<script>
    ...
    app.controller('orgCtrl', function ($scope, $http) {
        $scope.saveOrg = function () {
            ...
            if (id != "") {  //修改
//                alert(id);
                var url = 'http://192.168.1.200:8080/api/baseOrgs/' + id;
                console.log(params);
                $http({
                    method: 'put',
                    url: url,
                    ...
                    if (state == '205') {
                        alert("success");
                        $('#table').bootstrapTable('refresh', {url: 'http://192.168.1.200:8080/api/baseOrgs'});
                    } else {
                        alert("error");
                    }
                }).error(function (data) {
                ...
                var url = 'http://192.168.1.200:8080/api/baseOrgs';
